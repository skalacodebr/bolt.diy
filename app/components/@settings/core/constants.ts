...
export const TAB_DESCRIPTIONS: Record<TabType, string> = {
  ...
  database: 'Manage database connections and settings',
};
...
export const DEFAULT_TAB_CONFIG = [
  ...
  { id: 'database', visible: true, window: 'user' as const, order: 7 },
  ...
  { id: 'database', visible: true, window: 'developer' as const, order: 2 },
